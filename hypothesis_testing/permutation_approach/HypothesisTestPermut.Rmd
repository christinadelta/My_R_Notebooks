...
We see that using the above function, it makes the code a lot shorter, les complicated and easier to read. For more info about the **tapply** function see here: https://www.rdocumentation.org/packages/base/versions/3.6.2/topics/tapply 
